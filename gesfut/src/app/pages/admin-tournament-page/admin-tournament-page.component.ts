...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, AddPlayerComponent, NavbarComponent,CreateTeamComponent, TournamentDashboardComponent, InitializeTournamentComponent, ListTeamsTournamentsComponent, ListMatchDaysComponent, LoadResultComponent, LastsMatchesComponent, LeaderboardComponent, CreatePrizesComponent],
